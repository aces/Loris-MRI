...
my @script_list = (
    ...
    'uploadNeuroDB/NeuroDB/DatabaseException.pm',
    'uploadNeuroDB/NeuroDB/Database.pm',
    ...
    'uploadNeuroDB/NeuroDB/objectBroker/ConfigOB.pm',
    'uploadNeuroDB/NeuroDB/objectBroker/GetRole.pm',
    'uploadNeuroDB/NeuroDB/objectBroker/InsertRole.pm',
    'uploadNeuroDB/NeuroDB/objectBroker/MriScannerOB.pm',
    'uploadNeuroDB/NeuroDB/objectBroker/MriScanTypeOB.pm',
    'uploadNeuroDB/NeuroDB/objectBroker/MriUploadOB.pm',
    'uploadNeuroDB/NeuroDB/objectBroker/ObjectBrokerException.pm',
    'uploadNeuroDB/NeuroDB/objectBroker/ObjectBroker.pm',
    'uploadNeuroDB/NeuroDB/objectBroker/PSCOB.pm',
    'uploadNeuroDB/NeuroDB/objectBroker/TarchiveOB.pm',
    'uploadNeuroDB/NeuroDB/UnexpectedValueException.pm',
    'uploadNeuroDB/bin/concat_mri.pl',
    'uploadNeuroDB/bin/mincpik.pl',
    'uploadNeuroDB/batch_uploads_imageuploader.pl',
    'uploadNeuroDB/batch_uploads_tarchive.pl',
