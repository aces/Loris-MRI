...
import numpy as np
from loris_utils.iter import get_first
...
class MegCtfHeadShapeFile:
    ...
    def nasion(self) -> MegCtfHeadShapePoint | None:
        ...
        return get_first(self.points, ['NAS', 'Nasion', 'nasion'])
    ...
    def lpa(self) -> MegCtfHeadShapePoint | None:
        ...
        return get_first(self.points, ['LPA', 'left'])
    ...
    def rpa(self) -> MegCtfHeadShapePoint | None:
        ...
        return get_first(self.points, ['RPA', 'right'])
