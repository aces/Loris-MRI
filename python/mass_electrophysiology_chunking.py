...
def input_error_checking(profile, smallest_id, largest_id, usage):
    ...
    :param profile    : path to the profile file with MySQL credentials
     :type profile    : str
    :param smallest_id: path to the BIDS directory to parse and insert into LORIS
     :type smallest_id: str
    :param largest_id : path to the BIDS directory to parse and insert into LORIS
     :type largest_id : str
